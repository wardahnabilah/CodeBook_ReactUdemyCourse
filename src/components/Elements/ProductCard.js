...
export function ProductCard({ product }) {
  ...
  return (
    <div className="w-[23rem] h-[33.5rem] mx-auto mb-12 shadow-2xl rounded-xl overflow-hidden dark:bg-slate-800">
      ...
      <div className="h-[17.5rem] p-6 text-left flex flex-col">
